...
cmp_files = ["hept_Trivalency_recursive_" + suffix,
    # "hept_Trivalency_spi_d_struct_opt_" + suffix,
    "hept_Trivalency_spi_d_" + suffix,
    "hept_Trivalency_nmc_" + suffix,
    "hept_Trivalency_lps_" + suffix,
    "hept_Trivalency_rss2_r50_" + suffix,
    "hept_Trivalency_pll_d_" + suffix,
    "hept_Trivalency_dijk_"  + suffix,
    ]
...
for r in r_list:
    ...
    cmp_files.append(("hept_Trivalency_spi_d_r%0.6f_" + suffix) % r)
for k in [1, 2, 3, 4]:
    # cmp_files.append("hept_Trivalency_spi_d_k%d_struct_opt_10000.res" % k)
    cmp_files.append(("hept_Trivalency_spi_d_k%d_" + suffix) % k)
...
def draw(name, metrics, header):
    ...
    plt.ylabel(header)
    plt.legend()
    plt.savefig(dataset + '_' + header + '_' + name + '.png', dpi=600)
